 ...
 * Edit the original source file "test_table_max_length.ts" instead.
 */

#include <check.h>

#line 1 "test_table_max_length.ts"
/**
...
START_TEST(test_table_max_length)
{
#line 92
    table_t *table;
    int i;
...
START_TEST(test_table_max_length_after_resize)
{
#line 103
    table_t *table;
    table_t *check_table;
...
int main(void)
{
    ...
    tcase_add_test(tc1_1, test_table_max_length);
    tcase_add_test(tc1_1, test_table_max_length_after_resize);
