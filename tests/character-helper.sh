...
# Hex: \x09 / CHARACTER TABULATION
CHAR_09=$(printf "\011")
export CHAR_09;

# Hex: \x3f / QUESTION MARK
CHAR_3F=$(printf "\077")
export CHAR_3F;
...
# Hex: \xa0 / NO-BREAK SPACE
CHAR_A0=$(printf "\240")
export CHAR_A0;

# Hex: \xa9 / COPYRIGHT SIGN
CHAR_A9=$(printf "\251")
export CHAR_A9;
...
# Hex: \xbe / VULGAR FRACTION THREE QUARTERS
CHAR_BE=$(printf "\276")
export CHAR_BE;

# Hex: \xbf / INVERTED QUESTION MARK
CHAR_BF=$(printf "\277")
export CHAR_BF;

# Hex: \xc0 / LATIN CAPITAL LETTER A WITH GRAVE
CHAR_C0=$(printf "\300")
export CHAR_C0;

# Hex: \xc1 / LATIN CAPITAL LETTER A WITH ACUTE
CHAR_C1=$(printf "\301")
export CHAR_C1;

# Hex: \xc6 / LATIN CAPITAL LETTER AE
CHAR_C6=$(printf "\306")
export CHAR_C6;

# Hex: \xde / LATIN CAPITAL LETTER THORN
CHAR_DE=$(printf "\336")
export CHAR_DE;
